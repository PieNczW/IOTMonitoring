    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button
                        class="btn btn-white border shadow-sm rounded-pill px-3 py-2 d-flex align-items-center gap-2 dropdown-toggle"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2" style="min-width: 200px;">
                        <li>
                            <h6 class="dropdown-header text-muted text-uppercase small">Menu Pengguna</h6>
                        </li>
                        <li>
                ...
                <form action="{{ url('/dashboard') }}" method="GET" class="d-flex flex-wrap align-items-center gap-2">
                    <div class="d-flex align-items-center">
                        ...
                        <select name="period"
                            ...
                            <option value="daily" {{ $period == 'daily' || $period == 'today' ? 'selected' : '' }}>
                                Harian
                            </option>
                    ...
                    @if ($period == 'daily' || $period == 'today')
                        <div class="input-group-custom" title="Pilih Tanggal">
                            <input type="date" name="date"
                                ...
                                value="{{ $dateInput }}" onchange="this.form.submit()" style="max-width: 130px;">
                        </div>
                    @endif
                    ...
                    @if ($period == 'weekly')
                        <div class="input-group-custom" title="Pilih Minggu">
                            <input type="week" name="week"
                                class="form-control form-control-sm border-secondary-subtle"
                                value="{{ $weekInput }}" onchange="this.form.submit()" style="max-width: 150px;">
                        </div>
                    @endif
                    ...
                    @if ($period == 'monthly')
                        <div class="input-group-custom" title="Pilih Bulan">
                            <input type="month" name="month"
                                class="form-control form-control-sm border-secondary-subtle"
                                value="{{ $monthInput }}" onchange="this.form.submit()" style="max-width: 150px;">
                        </div>
                    @endif
    ...
    <div class="card shadow-sm border-start border-4 border-info h-100">
                                ...
                                <div class="col-md-6 mb-3 mb-md-0 border-end">
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">Status:
                                            <strong>{{ strtoupper($setting->mode) }}</strong></small>
                                    </div>
                                </div>
                                    ...
                                    <div class="mt-2">
                                        @if ($setting->mode == 'auto')
                                            <small class="text-danger fst-italic">
                                                <i class="fas fa-info-circle me-1"></i> Ubah ke mode Manual untuk
                                                mengontrol.
                                            </small>
                                        @else
        ...
        <div class="row mb-4 g-3">
                ...
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body p-0">
                        <div class="row g-0 h-100">
                            ...
                            <div class="col-md-4 border-end p-3 d-flex flex-column justify-content-center">
                                ...
                                <div class="d-flex justify-content-between align-items-end px-2">
                                    <div class="text-start">
                                        ...
                                        <span class="fs-4 fw-bold">
                                            <span class="temp-data"
                                                data-val="{{ $stats['max_temp'] }}">{{ $stats['max_temp'] }}</span>
                                    ...
                                    <div class="text-end">
                                        ...
                                        <span class="fs-4 fw-bold">
                                            <span class="temp-data"
                                                data-val="{{ $stats['min_temp'] }}">{{ $stats['min_temp'] }}</span>
                                            <small class="fs-6 opacity-75 unit-label">°C</small>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 border-end p-3 d-flex flex-column justify-content-center">
                                <small class="fw-bold d-block text-center text-uppercase mb-3 opacity-75"
                                    style="letter-spacing: 1px;">GAS (MQ135)</small>
                                <div class="d-flex justify-content-between align-items-end px-2">
                                    <div class="text-start">
                                        <span class="d-block text-danger small fw-bold mb-1">MAX</span>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    <div
                        class="card-body position-relative d-flex justify-content-center align-items-center flex-column py-4">
        ...
        @if ($isAdmin)
            <div class="card mb-5">
                <div class="card-header fw-bold"><i class="fas fa-list"></i> 10 Data Terakhir dari
                    {{ $label }}
                </div>
                <div class="card-body p-0">
                ...
                <div class="card-footer border-0 text-end py-3">
                    <a href="{{ url('/export-excel') }}"
                        class="btn btn-success btn-sm shadow-sm rounded-pill px-4"><i
